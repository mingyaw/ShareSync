...
Status: M13 developer handoff guide.

This guide is for local development only. ShareSync M13 remains a photo-only Android-to-iPhone local sync MVP and should not be treated as an App Store or Google Play release candidate.
