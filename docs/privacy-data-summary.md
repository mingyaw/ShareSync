...
ShareSync has no application-operated photo relay, account system, advertising SDK, or analytics SDK in the M42 source tree. iCloud behavior is provided by Apple Photos after import and depends on the user's settings.
