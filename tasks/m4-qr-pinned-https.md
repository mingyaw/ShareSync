...
- [x] Add unit coverage for wrong certificate, stale token, and invalid signature paths.
...
### 2026-09-10 M4.4 Error Path Coverage

Completed the transport-switch unit coverage pass:
